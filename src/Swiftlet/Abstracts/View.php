...
abstract class View extends Common implements ViewInterface
{
	...
	public function render()
	{
        ...
        else if ( is_file($file = $this->vendorPath . $this->vendor . '/views/' . $this->name . '.php') ) {
			include $file;
		}
        else if (is_file($file = $this->vendorPath . $this->vendor . '/views/' . $this->name . '.tpl')){
            $this->name = $this->name . '.tpl';
        }
        else {
