...
abstract class App extends Common implements AppInterface
{
	...
	public function serve()
	{
        ...
        $this->registerHook('renderBefore', $this->controller, $this->view);

		$this->view->render();

        $this->registerHook('renderAfter', $this->controller, $this->view);
     ...
     * @return mixed
     */
	public function getConfig($variable,$fallback=null)
	{
		return isset($this->config[$variable]) ? $this->config[$variable] : $fallback;
	}
